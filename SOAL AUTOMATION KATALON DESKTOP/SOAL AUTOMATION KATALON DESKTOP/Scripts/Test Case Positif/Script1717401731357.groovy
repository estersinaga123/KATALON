...
Windows.setText(findWindowsObject('Object Repository/LoginPage/Username'), 'validUser')
Windows.setText(findWindowsObject('Object Repository/LoginPage/Password'), 'validPass')
