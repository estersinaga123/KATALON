...
Windows.setText(findWindowsObject('Object Repository/LoginPage/Username'), 'invalidUser')
Windows.setText(findWindowsObject('Object Repository/LoginPage/Password'), 'invalidPass')
